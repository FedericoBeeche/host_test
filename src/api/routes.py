...
def populate():
    ...
    t3 = Tutorial(name='Zoom videollamada', title='Mi primer videollamada en Zoom (para celular)', description='¿Cómo invitar a amigos, familia, y hasta mis mascotas?', link='/guide_ZoomCalls', img='https://ichef.bbci.co.uk/news/976/cpsprodpb/AA1D/production/_116094534_46bd3031-50b2-492b-9505-6c270c0fbf45.jpg')
