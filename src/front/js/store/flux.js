...
const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			...
			favorites: [],
			current_username: "",
			frontend_url: "https://3000-peach-parrotfish-p0lyne0w.ws-us03.gitpod.io/", // change this! Use current frontend url

			url: "https://3001-peach-parrotfish-p0lyne0w.ws-us03.gitpod.io" // change this! do NOT add slash '/' at the end
		},
		actions: {
