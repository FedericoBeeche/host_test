...
const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			...
			favorites: [],
			current_username: "",
			frontend_url: "https://3000-apricot-tiglon-pkr3kt0g.ws-us08.gitpod.io/", // change this! Use current frontend url INCLUDE slash

			url: "https://3001-apricot-tiglon-pkr3kt0g.ws-us08.gitpod.io" // change this! do NOT add slash '/' at the end
		},
		actions: {
